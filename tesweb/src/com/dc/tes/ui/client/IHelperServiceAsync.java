 ...
 *
 */
public interface IHelperServiceAsync{
	/**
	 * 名称唯一性判断
	 ...
	 */
	void IsNameDistinct(IDistValidate validator,String validateValue, AsyncCallback<Boolean> callback);
	/**
	 ...
	 * @throws Exception 
	 */
	void GetTESConfig(String confRoot, AsyncCallback<List<GWTProperties>> callback);
}
