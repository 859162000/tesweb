...
public class GWTScriptFlow extends BaseModelData implements Serializable,IDistValidate{
	private static final long serialVersionUID = 1405539807111849187L;
	
	public static String N_ID = "id";
	public static String N_Name = "name";
	public static String N_Desc = "description";
	public static String N_Srcipt = "srcipt";
	...
	public GWTScriptFlow()
	{
	}
	
	public GWTScriptFlow(String sysId){
		this("","","",sysId);
	}
	
	public GWTScriptFlow(String id,String name, String desc,String sysId) {
		this.set(N_ID, id);
	...
	{
		this.set(N_Srcipt,script);
	}
	
	public String getScript()
	{
		return this.get(N_Srcipt);
	}
