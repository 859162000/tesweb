...
Language.syntax = [
	...
	{
	    input: /\b(IN|OUT|REG)\b/g,
	    output: '<s>$1</s>' 
	}, // system key word for project
	{
...
Language.keyword = [
	...
	"void", "case", "default", "else", "function",
	 "return", "typeof", "while", "if", "label",
	 "switch", "var", "with", "catch", "boolean", 
	 "int", "try", "false", "throws", "null", "true", "goto"
]
