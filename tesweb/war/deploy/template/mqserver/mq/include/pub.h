...
extern int	Embedded;		/*捎带标志*/	
extern int	Attached;		/*附件标志*/

//static int	DataSize;					/*报文数据大小*/
extern long	DataSize;					/*报文数据大小*/
extern int	XmlDataSize;			/*应用报文(明文)大小*/

extern char	Data[MAXDATASIZE];
extern char	XmlData[MAXDATASIZE];
...
/*声明API空间指针*/
/*extern char *send,*rcv,*log;  */
extern char *sendbuf,*rcv;  
/*声明API参数长度*/
extern int len_slog;

/*安全处理*/
//static unsigned	char	MacType[16];
extern char	MacType[16];
