...
import com.dc.tes.adapter.secure.encrypt.EncryptClass2;

public class SoapRequestFactory extends AbstractFactory {
	...
	public IEncryptAdapterSecure getEncryptAdapterSecure() {
		// 生成实现 加密接口的类 实例
		return (IEncryptAdapterSecure) new EncryptClass2();
	}
